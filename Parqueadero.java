...
public class Parqueadero {
    ...
    public String metodo1() {
        ...
        for (Puesto p: puestos){
            ...
            if (p.estaOcupado() && horaActual-p.darCarro().darHoraLlegada()>Hmayor){
                Hmayor=horaActual-p.darCarro().darHoraLlegada();
                placaMayor = p.darCarro().darPlaca();
            }
    ...
    public String metodo2() {
        ...
        if (calcularPuestosLibres()==0){
            respuesta= "El parqueadero está lleno";
        }
        else {
            respuesta= "“Hay puestos disponibles";
        }
        return respuesta;
    }
